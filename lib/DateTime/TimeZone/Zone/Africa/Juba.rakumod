...
unit class DateTime::TimeZone::Zone::Africa::Juba does DateTime::TimeZone::Zone;
has %.rules = ( 
...
has @.zonedata = [{:baseoffset("2:06:28"), :rules(""), :until(-1230768000)}, {:baseoffset("2:00"), :rules("Sudan"), :until(947937600)}, {:baseoffset("3:00"), :rules(""), :until(Inf)}];
