...
has @.zonedata = [{:baseoffset("2:10:08"), :rules(""), :until(-1230768000)}, {:baseoffset("2:00"), :rules("Sudan"), :until(947937600)}, {:baseoffset("3:00"), :rules(""), :until(1509494400)}, {:baseoffset("2:00"), :rules(""), :until(Inf)}];
