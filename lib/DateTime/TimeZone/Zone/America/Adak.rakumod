...
class DateTime::TimeZone::Zone::America::Atka
  is DateTime::TimeZone::Zone::America::Adak {
    method name(--> 'America/Atka') { }
}

class DateTime::TimeZone::Zone::US::Aleutian
  is DateTime::TimeZone::Zone::America::Adak {
    method name(--> 'US/Aleutian') { }
}
