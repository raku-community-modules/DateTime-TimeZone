...
class DateTime::TimeZone::Zone::America::Argentina::San_Luis
  does DateTime::TimeZone::Zone
{
    method name(--> 'America/Argentina/San_Luis') { }

    method zonedata() {
        BEGIN Map.new((:baseoffset("-4:25:24"),:until(-2372112000))), Map.new((:baseoffset("-4:16:48"),:until(-1567468800))), Map.new((:baseoffset("-4:00"),:until(-1233446400))), Map.new((:baseoffset("-4:00"),:rule("Arg"),:until(-7603200))), Map.new((:baseoffset("-3:00"),:rule("Arg"),:until(631152000))), Map.new((:baseoffset("-2:00:00"),:until(637372800))), Map.new((:baseoffset("-4:00"),:until(655948800))), Map.new((:baseoffset("-3:00:00"),:until(667785600))), Map.new((:baseoffset("-4:00"),:until(675734400))), Map.new((:baseoffset("-3:00"),:until(938908800))), Map.new((:baseoffset("-3:00:00"),:until(952041600))), Map.new((:baseoffset("-3:00"),:until(1085961600))), Map.new((:baseoffset("-4:00"),:until(1090713600))), Map.new((:baseoffset("-3:00"),:rule("Arg"),:until(1200873600))), Map.new((:baseoffset("-4:00"),:rule("SanLuis"),:until(1255219200))), Map.new((:baseoffset("-3:00")))
    }
    ...
    method rules() {
        BEGIN Map.new: (
          ...
          'SanLuis' => (Map.new((:dow((7, 8)),:month(3),:years(2008..2009))), Map.new((:adjust("1:00"),:dow((7, 8)),:month(10),:years(2007..2008)))),
        )
    }
}
