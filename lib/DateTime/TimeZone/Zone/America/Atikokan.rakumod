  ...
  does DateTime::TimeZone::Zone
{
    ...
    method zonedata() {
        BEGIN Map.new((:baseoffset("-6:06:28"),:until(-2366755200))), Map.new((:baseoffset("-6:00"),:rules("Canada"),:until(-923270400))), Map.new((:baseoffset("-5:00:00"),:until(-880236000))), Map.new((:baseoffset("-6:00"),:rules("Canada"),:until(-765410400))), Map.new((:baseoffset("-5:00")))
    }
