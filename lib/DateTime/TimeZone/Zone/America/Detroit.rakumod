...
class DateTime::TimeZone::Zone::America::Detroit
  does DateTime::TimeZone::Zone
{
    ...
    method rules() {
        BEGIN Map.new: (
          'Detroit' => (Map.new((:adjust("1:00"),:lastdow(7),:letter("D"),:month(4),:time("2:00"),:years(1948))), Map.new((:lastdow(7),:letter("S"),:month(9),:time("2:00"),:years(1948)))),
...
class DateTime::TimeZone::Zone::US::Michigan
  is DateTime::TimeZone::Zone::America::Detroit {
    method name(--> 'US/Michigan') { }
}
