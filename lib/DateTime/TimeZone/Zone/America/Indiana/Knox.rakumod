...
class DateTime::TimeZone::Zone::America::Indiana::Knox
  does DateTime::TimeZone::Zone
{
    ...
    method rules() {
        BEGIN Map.new: (
          'Starke' => (Map.new((:adjust("1:00"),:lastdow(7),:letter("D"),:month(4),:time("2:00"),:years(1947..1961))), Map.new((:lastdow(7),:letter("S"),:month(9),:time("2:00"),:years(1947..1954))), Map.new((:lastdow(7),:letter("S"),:month(10),:time("2:00"),:years(1955..1956))), Map.new((:lastdow(7),:letter("S"),:month(9),:time("2:00"),:years(1957..1958))), Map.new((:lastdow(7),:letter("S"),:month(10),:time("2:00"),:years(1959..1961)))),
