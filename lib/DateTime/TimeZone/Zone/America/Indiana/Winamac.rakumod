...
class DateTime::TimeZone::Zone::America::Indiana::Winamac
  does DateTime::TimeZone::Zone
{
    ...
    method rules() {
        BEGIN Map.new: (
          'Pulaski' => (Map.new((:adjust("1:00"),:lastdow(7),:letter("D"),:month(4),:time("2:00"),:years(1946..1960))), Map.new((:lastdow(7),:letter("S"),:month(9),:time("2:00"),:years(1946..1954))), Map.new((:lastdow(7),:letter("S"),:month(10),:time("2:00"),:years(1955..1956))), Map.new((:lastdow(7),:letter("S"),:month(9),:time("2:00"),:years(1957..1960)))),
