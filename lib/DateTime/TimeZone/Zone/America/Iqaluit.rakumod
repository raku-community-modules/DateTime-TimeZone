  ...
  does DateTime::TimeZone::Zone
{
    ...
    method zonedata() {
        BEGIN Map.new((:baseoffset("0"),:until(-865296000))), Map.new((:baseoffset("-5:00"),:rules("NT_YK"),:until(941335200))), Map.new((:baseoffset("-6:00"),:rules("Canada"),:until(972784800))), Map.new((:baseoffset("-5:00"),:rules("Canada")))
    }
