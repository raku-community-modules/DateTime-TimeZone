...
class DateTime::TimeZone::Zone::America::Iqaluit
  does DateTime::TimeZone::Zone
{
    method name(--> 'America/Iqaluit') { }

    method zonedata() {
        BEGIN Map.new((:baseoffset("0"),:until(-865296000))), Map.new((:baseoffset("-5:00"),:rule("NT_YK"),:until(941335200))), Map.new((:baseoffset("-6:00"),:rule("Canada"),:until(972784800))), Map.new((:baseoffset("-5:00"),:rule("Canada")))
    }
