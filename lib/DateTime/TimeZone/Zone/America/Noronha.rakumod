...
class DateTime::TimeZone::Zone::America::Noronha
...
class DateTime::TimeZone::Zone::Brazil::DeNoronha
  is DateTime::TimeZone::Zone::America::Noronha {
    method name(--> 'Brazil/DeNoronha') { }
}
