...
class DateTime::TimeZone::Zone::America::Santo_Domingo
  does DateTime::TimeZone::Zone
{
    ...
    method rules() {
        BEGIN Map.new: (
          'DR' => (Map.new((:adjust("1:00"),:date(30),:letter("EDT"),:month(10),:years(1966))), Map.new((:date(28),:letter("EST"),:month(2),:years(1967))), Map.new((:adjust("0:30"),:lastdow(7),:letter("-0430"),:month(10),:years(1969..1973))), Map.new((:date(21),:letter("EST"),:month(2),:years(1970))), Map.new((:date(20),:letter("EST"),:month(1),:years(1971))), Map.new((:date(21),:letter("EST"),:month(1),:years(1972..1974)))),
