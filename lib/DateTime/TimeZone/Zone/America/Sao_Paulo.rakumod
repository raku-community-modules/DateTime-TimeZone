...
class DateTime::TimeZone::Zone::America::Sao_Paulo
...
class DateTime::TimeZone::Zone::Brazil::East
  is DateTime::TimeZone::Zone::America::Sao_Paulo {
    method name(--> 'Brazil/East') { }
}
