...
has @.zonedata = [{:baseoffset("3:53:32"), :rules(""), :until(-1441152000)}, {:baseoffset("4:00"), :rules(""), :until(-1247529600)}, {:baseoffset("5:00"), :rules("RussiaAsia"), :until(670384800)}, {:baseoffset("4:00"), :rules("RussiaAsia"), :until(695786400)}, {:baseoffset("5:00"), :rules(""), :until(Inf)}];
