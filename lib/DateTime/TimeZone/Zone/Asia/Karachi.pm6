...
has @.zonedata = Array.new({"baseoffset" => "4:28:12", "rules" => "", "until" => -1988150400}, {"baseoffset" => "5:30", "rules" => "", "until" => -883612800}, {"baseoffset" => "5:30", "rules" => "1:00", "until" => -764121600}, {"baseoffset" => "5:30", "rules" => "", "until" => -576115200}, {"baseoffset" => "5:00", "rules" => "", "until" => 38793600}, {"baseoffset" => "5:00", "rules" => "Pakistan", "until" => Inf});
