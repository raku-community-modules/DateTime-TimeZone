  ...
  does DateTime::TimeZone::Zone
{
    ...
    method zonedata() {
        BEGIN Map.new((:baseoffset("4:53:30"),:until(-1582070400))), Map.new((:baseoffset("5:00"),:until(-1247529600))), Map.new((:baseoffset("6:00"),:rules("Russia"),:until(670384800))), Map.new((:baseoffset("5:00"),:rules("Russia"),:until(695786400))), Map.new((:baseoffset("6:00"),:rules("Russia"),:until(1301191200))), Map.new((:baseoffset("7:00"),:until(1414288800))), Map.new((:baseoffset("6:00")))
    }
