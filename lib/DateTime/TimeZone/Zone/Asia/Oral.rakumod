  ...
  does DateTime::TimeZone::Zone
{
    ...
    method zonedata() {
        BEGIN Map.new((:baseoffset("3:25:24"),:until(-1441152000))), Map.new((:baseoffset("3:00"),:until(-1247529600))), Map.new((:baseoffset("5:00"),:until(354931200))), Map.new((:baseoffset("6:00:00"),:until(370742400))), Map.new((:baseoffset("6:00"),:until(386467200))), Map.new((:baseoffset("5:00"),:rules("RussiaAsia"),:until(606880800))), Map.new((:baseoffset("4:00"),:rules("RussiaAsia"),:until(695786400))), Map.new((:baseoffset("5:00"),:rules("RussiaAsia"),:until(701834400))), Map.new((:baseoffset("4:00"),:rules("RussiaAsia"),:until(1099188000))), Map.new((:baseoffset("5:00")))
    }
