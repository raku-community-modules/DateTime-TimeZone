...
unit class DateTime::TimeZone::Zone::Asia::Qostanay does DateTime::TimeZone::Zone;
has %.rules = ( 
...
has @.zonedata = [{:baseoffset("4:14:28"), :rules(""), :until(-1441152000)}, {:baseoffset("4:00"), :rules(""), :until(-1247529600)}, {:baseoffset("5:00"), :rules(""), :until(354931200)}, {:baseoffset("6:00"), :rules(""), :until(370742400)}, {:baseoffset("6:00"), :rules(""), :until(386467200)}, {:baseoffset("5:00"), :rules("RussiaAsia"), :until(670384800)}, {:baseoffset("4:00"), :rules("RussiaAsia"), :until(695786400)}, {:baseoffset("5:00"), :rules("RussiaAsia"), :until(1099188000)}, {:baseoffset("6:00"), :rules(""), :until(Inf)}];
