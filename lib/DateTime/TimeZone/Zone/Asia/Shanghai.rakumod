...
class DateTime::TimeZone::Zone::Asia::Chongqing
  is DateTime::TimeZone::Zone::Asia::Shanghai {
    method name(--> 'Asia/Chongqing') { }
}

class DateTime::TimeZone::Zone::Asia::Chungking
  is DateTime::TimeZone::Zone::Asia::Shanghai {
    method name(--> 'Asia/Chungking') { }
}

class DateTime::TimeZone::Zone::Asia::Harbin
  is DateTime::TimeZone::Zone::Asia::Shanghai {
    method name(--> 'Asia/Harbin') { }
}

class DateTime::TimeZone::Zone::PRC
  is DateTime::TimeZone::Zone::Asia::Shanghai {
    method name(--> 'PRC') { }
}
