...
class DateTime::TimeZone::Zone::Asia::Ulaanbaatar
  does DateTime::TimeZone::Zone
{
    method name(--> 'Asia/Ulaanbaatar') { }

    method zonedata() {
        BEGIN Map.new((:baseoffset("7:07:32"),:until(-2032905600))), Map.new((:baseoffset("7:00"),:until(252460800))), Map.new((:baseoffset("8:00"),:rule("Mongol")))
    }
...
class DateTime::TimeZone::Zone::Asia::Ulan_Bator
  is DateTime::TimeZone::Zone::Asia::Ulaanbaatar {
    method name(--> 'Asia/Ulan_Bator') { }
}
