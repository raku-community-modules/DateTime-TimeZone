...
has @.zonedata = [{:baseoffset("-1:01:36"), :rules(""), :until(-1514764800)}, {:baseoffset("-1:00"), :rules(""), :until(-733878000)}, {:baseoffset("0:00"), :rules(""), :until(323827200)}, {:baseoffset("1:00"), :rules(""), :until(338950800)}, {:baseoffset("0:00"), :rules("EU"), :until(Inf)}];
