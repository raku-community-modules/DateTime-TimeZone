...
has @.zonedata = Array.new({"baseoffset" => "-1:01:36", "rules" => "", "until" => -1514764800}, {"baseoffset" => "-1:00", "rules" => "", "until" => -733878000}, {"baseoffset" => "0:00", "rules" => "", "until" => 323827200}, {"baseoffset" => "0:00", "rules" => "1:00", "until" => 338947200}, {"baseoffset" => "0:00", "rules" => "EU", "until" => Inf});
