...
class DateTime::TimeZone::Zone::Atlantic::Faroe
...
class DateTime::TimeZone::Zone::Atlantic::Faeroe
  is DateTime::TimeZone::Zone::Atlantic::Faroe {
    method name(--> 'Atlantic/Faeroe') { }
}
