...
has %.rules = ( 
 AQ => $[{:adjust("1:00"), :lastdow(7), :letter("D"), :month(10), :time("2:00s"), :years(1971..1971)}, {:adjust("0"), :lastdow(7), :letter("S"), :month(2), :time("2:00s"), :years(1972..1972)}, {:adjust("1:00"), :lastdow(7), :letter("D"), :month(10), :time("2:00s"), :years(1989..1991)}, {:adjust("0"), :dow(${:dow(7), :mindate("1")}), :letter("S"), :month(3), :time("2:00s"), :years(1990..1992)}],
 ...
 Holiday => $[{:adjust("1:00"), :lastdow(7), :letter("D"), :month(10), :time("2:00s"), :years(1992..1993)}, {:adjust("0"), :dow(${:dow(7), :mindate("1")}), :letter("S"), :month(3), :time("2:00s"), :years(1993..1994)}],
);
