...
class DateTime::TimeZone::Zone::Australia::Perth
  does DateTime::TimeZone::Zone
{
    method name(--> 'Australia/Perth') { }

    method zonedata() {
        BEGIN Map.new((:baseoffset("7:43:24"),:until(-2337897600))), Map.new((:baseoffset("8:00"),:rule("Aus"),:until(-836438400))), Map.new((:baseoffset("8:00"),:rule("AW")))
    }
...
class DateTime::TimeZone::Zone::Australia::West
  is DateTime::TimeZone::Zone::Australia::Perth {
    method name(--> 'Australia/West') { }
}
