  ...
  does DateTime::TimeZone::Zone
{
    ...
    method rules() {
        BEGIN Map.new: (
          ...
          'Hungary' => (Map.new((:adjust("1:00"),:date(1),:letter("S"),:month(4),:time("3:00"),:years(1918))), Map.new((:date(16),:month(9),:time("3:00"),:years(1918))), Map.new((:adjust("1:00"),:date(15),:letter("S"),:month(4),:time("3:00"),:years(1919))), Map.new((:date(24),:month(11),:time("3:00"),:years(1919))), Map.new((:adjust("1:00"),:date(1),:letter("S"),:month(5),:time("23:00"),:years(1945))), Map.new((:date(1),:month(11),:years(1945))), Map.new((:adjust("1:00"),:date(31),:letter("S"),:month(3),:time("2:00"),:years(1946))), Map.new((:dow((7, 1)),:month(10),:time("2:00"),:years(1946..1949))), Map.new((:adjust("1:00"),:dow((7, 4)),:letter("S"),:month(4),:time("2:00"),:years(1947..1949))), Map.new((:adjust("1:00"),:date(17),:letter("S"),:month(4),:time("2:00"),:years(1950))), Map.new((:date(23),:month(10),:time("2:00"),:years(1950))), Map.new((:adjust("1:00"),:date(23),:letter("S"),:month(5),:years(1954..1955))), Map.new((:date(3),:month(10),:years(1954..1955))), Map.new((:adjust("1:00"),:dow((7, 1)),:letter("S"),:month(6),:years(1956))), Map.new((:lastdow(7),:month(9),:years(1956))), Map.new((:adjust("1:00"),:dow((7, 1)),:letter("S"),:month(6),:time("1:00"),:years(1957))), Map.new((:lastdow(7),:month(9),:time("3:00"),:years(1957))), Map.new((:adjust("1:00"),:date(6),:letter("S"),:month(4),:time("1:00"),:years(1980)))),
        )
    }
}
