  ...
  does DateTime::TimeZone::Zone
{
    ...
    method rules() {
        BEGIN Map.new: (
          ...
          'Romania' => (Map.new((:adjust("1:00"),:date(21),:letter("S"),:month(5),:years(1932))), Map.new((:dow((7, 1)),:month(10),:years(1932..1939))), Map.new((:adjust("1:00"),:dow((7, 2)),:letter("S"),:month(4),:years(1933..1939))), Map.new((:adjust("1:00"),:date(27),:letter("S"),:month(5),:years(1979))), Map.new((:lastdow(7),:month(9),:years(1979))), Map.new((:adjust("1:00"),:date(5),:letter("S"),:month(4),:time("23:00"),:years(1980))), Map.new((:lastdow(7),:month(9),:time("1:00"),:years(1980))), Map.new((:adjust("1:00"),:lastdow(7),:letter("S"),:month(3),:years(1991..1993))), Map.new((:lastdow(7),:month(9),:years(1991..1993)))),
