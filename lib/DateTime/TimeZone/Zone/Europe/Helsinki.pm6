...
has %.rules = ( 
 ...
 Finland => $[{:adjust("1:00"), :date("2"), :letter("S"), :month(4), :time("24:00"), :years(1942..1942)}, {:adjust("0"), :date("4"), :letter("-"), :month(10), :time("1:00"), :years(1942..1942)}, {:adjust("1:00"), :lastdow(7), :letter("S"), :month(3), :time("2:00"), :years(1981..1982)}, {:adjust("0"), :lastdow(7), :letter("-"), :month(9), :time("3:00"), :years(1981..1982)}],
);
has @.zonedata = [{:baseoffset("1:39:49"), :rules(""), :until(-2890252800)}, {:baseoffset("1:39:49"), :rules(""), :until(-1546300800)}, {:baseoffset("2:00"), :rules("Finland"), :until(410227200)}, {:baseoffset("2:00"), :rules("EU"), :until(Inf)}];
