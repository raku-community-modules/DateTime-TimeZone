...
class DateTime::TimeZone::Zone::Europe::Helsinki
  does DateTime::TimeZone::Zone
{
    ...
    method rules() {
        BEGIN Map.new: (
          ...
          'Finland' => (Map.new((:adjust("1:00"),:date(2),:letter("S"),:month(4),:time("24:00"),:years(1942))), Map.new((:date(4),:month(10),:time("1:00"),:years(1942))), Map.new((:adjust("1:00"),:lastdow(7),:letter("S"),:month(3),:time("2:00"),:years(1981..1982))), Map.new((:lastdow(7),:month(9),:time("3:00"),:years(1981..1982)))),
        )
    }
}

class DateTime::TimeZone::Zone::Europe::Mariehamn
  is DateTime::TimeZone::Zone::Europe::Helsinki {
    method name(--> 'Europe/Mariehamn') { }
}
