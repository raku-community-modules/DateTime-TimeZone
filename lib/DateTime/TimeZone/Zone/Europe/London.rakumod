...
class DateTime::TimeZone::Zone::Europe::London
...
class DateTime::TimeZone::Zone::Europe::Jersey
  is DateTime::TimeZone::Zone::Europe::London {
    method name(--> 'Europe/Jersey') { }
}

class DateTime::TimeZone::Zone::Europe::Guernsey
  is DateTime::TimeZone::Zone::Europe::London {
    method name(--> 'Europe/Guernsey') { }
}
