  ...
  does DateTime::TimeZone::Zone
{
    ...
    method rules() {
        BEGIN Map.new: (
          ...
          'Norway' => (Map.new((:adjust("1:00"),:date(22),:letter("S"),:month(5),:time("1:00"),:years(1916))), Map.new((:date(30),:month(9),:years(1916))), Map.new((:adjust("1:00"),:date(2),:letter("S"),:month(4),:time("2:00"),:years(1945))), Map.new((:date(1),:month(10),:time("2:00"),:years(1945))), Map.new((:adjust("1:00"),:dow((7, 15)),:letter("S"),:month(3),:time("2:00"),:years(1959..1964))), Map.new((:dow((7, 15)),:month(9),:time("2:00"),:years(1959..1965))), Map.new((:adjust("1:00"),:date(25),:letter("S"),:month(4),:time("2:00"),:years(1965)))),
        )
    }
}
