...
has @.zonedata = Array.new({"baseoffset" => "1:12:12", "rules" => "", "until" => -2871676800}, {"baseoffset" => "1:00:14", "rules" => "", "until" => -2208988800}, {"baseoffset" => "1:00", "rules" => "", "until" => -1692493200}, {"baseoffset" => "1:00", "rules" => "1:00", "until" => -1680476400}, {"baseoffset" => "1:00", "rules" => "", "until" => 315532800}, {"baseoffset" => "1:00", "rules" => "EU", "until" => Inf});
