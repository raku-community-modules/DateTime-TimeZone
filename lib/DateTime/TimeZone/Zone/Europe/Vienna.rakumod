  ...
  does DateTime::TimeZone::Zone
{
    ...
    method rules() {
        BEGIN Map.new: (
          'Austria' => (Map.new((:adjust("1:00"),:date(5),:letter("S"),:month(4),:time("2:00"),:years(1920))), Map.new((:date(13),:month(9),:time("2:00"),:years(1920))), Map.new((:adjust("1:00"),:date(14),:letter("S"),:month(4),:time("2:00"),:years(1946))), Map.new((:dow((7, 1)),:month(10),:time("2:00"),:years(1946..1948))), Map.new((:adjust("1:00"),:date(6),:letter("S"),:month(4),:time("2:00"),:years(1947))), Map.new((:adjust("1:00"),:date(18),:letter("S"),:month(4),:time("2:00"),:years(1948))), Map.new((:adjust("1:00"),:date(6),:letter("S"),:month(4),:years(1980))), Map.new((:date(28),:month(9),:years(1980)))),
