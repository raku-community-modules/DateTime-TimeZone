...
class DateTime::TimeZone::Zone::Pacific::Johnston
  is DateTime::TimeZone::Zone::Pacific::Honolulu {
    method name(--> 'Pacific/Johnston') { }
}

class DateTime::TimeZone::Zone::US::Hawaii
  is DateTime::TimeZone::Zone::Pacific::Honolulu {
    method name(--> 'US/Hawaii') { }
}
