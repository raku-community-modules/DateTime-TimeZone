  ...
  does DateTime::TimeZone::Zone
{
    ...
    method rules() {
        BEGIN Map.new: (
          'Tonga' => (Map.new((:adjust("1:00"),:date(7),:month(10),:time("2:00"),:years(1999))), Map.new((:date(19),:month(3),:time("2:00"),:years(2000))), Map.new((:adjust("1:00"),:dow((7, 1)),:month(11),:time("2:00"),:years(2000..2001))), Map.new((:lastdow(7),:month(1),:time("2:00"),:years(2001..2002))), Map.new((:adjust("1:00"),:dow((7, 1)),:month(11),:time("2:00"),:years(2016))), Map.new((:dow((7, 15)),:month(1),:time("3:00"),:years(2017)))),
        )
    }
}
